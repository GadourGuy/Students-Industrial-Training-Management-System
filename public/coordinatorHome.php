...
// You can add queries to get students under this coordinator's supervision
// $supervised_students_sql = "SELECT COUNT(*) as count FROM student WHERE coordinator_id = '$utmid'";

// You can add more fields as needed based on your database structure
$position = "Industrial Training Coordinator"; // Replace with actual field from database
$department = "Faculty of Computing"; // Replace with actual field from database
  ...
  <main class="container">
    ...
    <section class="quick-actions">
      ...
      <div class="action-buttons">
        ...
        <div class="action-card" onclick="location.href='coordinator_evaluations.php'">
          <img class="icon" src="../images/docIcon.png" alt="Evaluation Icon" />
          Student Evaluations
        </div>
        <div class="action-card" onclick="location.href='coordinator_reports.php'">
